      ...
      <div className="container">
        <div className="row justify-content-center">
          ...
          <div className="col-sm-12 col-md-12 col-lg-12 d-flex pt-5 lectures-content">
            {
            lectureDatas.map((data)=>(
              <div key={data.src} className="col-sm-12 col-md-6 col-lg-4 pb-4 lecturesBox">
                <div className="lecture-wrap ">
                  ...
                  <div className="p-2">
                    ...
                    <br />
                    <span className="time float-left mb-2 ">{data.time}</span>
                    <div className="statement float-left text-left">{data.statement}</div>
                    <span className="speaker float-left mt-3 text-left">
                      講者：
                      {data.lecturer}
                      | 時數：
                      {data.hours}
        ...
        <p className="more float-right"><a href="/lectures">...更多講座</a></p>
      </div>
    </section>
  );
};
